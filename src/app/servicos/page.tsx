      ...
      <Card>
        ...
        <form onSubmit={handleSearch} className="mb-6 flex flex-wrap gap-2 items-center">
          <input
            ...
            className="border-slate-300 focus:ring-indigo-500 focus:border-indigo-500 p-2 rounded-md w-full md:w-1/3 text-slate-900 border"
          ...
          <select
            ...
            className="border-slate-300 focus:ring-indigo-500 focus:border-indigo-500 p-2 rounded-md w-full md:w-1/4 text-slate-900 border"
          >
        ...
        {totalPages > 1 && (
          <div className="mt-6 flex justify-center items-center">
            <button
              ...
              className="bg-slate-200 hover:bg-slate-300 text-slate-800 font-medium py-2 px-4 rounded-l-md disabled:opacity-50 transition-colors"
            >
              Anterior
            </button>
            ...
            <button
              ...
              className="bg-slate-200 hover:bg-slate-300 text-slate-800 font-medium py-2 px-4 rounded-r-md disabled:opacity-50 transition-colors"
            >
              Próxima
            </button>
          </div>
